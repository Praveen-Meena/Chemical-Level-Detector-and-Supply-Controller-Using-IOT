	...
	var value=0;
   	...
   	if(value==0){
		fetch('https://chemical-level-indicator.000webhostapp.com/set_tank_capacity.php?tank_capacity=tankcapacity').then( data => {
...
//************************* MANUALY MOTOR  ON  *************************
   	function enable(){
	 	status=1;
		fetch('https://chemical-level-indicator.000webhostapp.com/set_Supply_status.php?status=1').then(data => {
...
//************************* MANUALY MOTOR OFF  *************************
   	function disable(){
		status=0;
		fetch('https://chemical-level-indicator.000webhostapp.com/set_Supply_status.php?status=0').then(data => {
